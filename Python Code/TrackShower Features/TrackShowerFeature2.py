...
def GetChainInfo(driftCoord, wireCoord, chainThreshold, rectWidth, rectHeight):
    ...
    while driftCoord:    # While pfo hit list is not empty
        chainX, chainY, chainLength = CreatePointChain2(driftCoord, wireCoord,
...
def RunAlgorithm(pfo):
    chainCount, avgLengthRatio = GetChainInfo(pfo.driftCoordW, pfo.wireCoordW, rectWidth, rectHeight)
